...
void smithWatermanParallel(const std::string& sequence1, const std::string& sequence2, int numThreads) {
...
int main() {
    ...
    int numThreads = 4; // Specify the number of threads manually

    smithWatermanParallel(sequence1, sequence2, numThreads);
